				        ...
				        <div class="panel-body">
                            <div class="container recent_product_container">
                              <div class="row recent_img">
                                <div class="col-md-4"><img src="images/volcano.jpeg" class="img-thumbnail home_img" alt="Buy"></div>
                                <div class="col-md-4"><img src="images/Mona%20Lisa.png" class="img-thumbnail home_img" alt="Buy"></div>
                                <div class="col-md-4"><img src="images/Krishna%20with%20Gopi's.Jpg" class="img-thumbnail home_img" alt="Buy"></div>
                              </div>
                                <div class="row recent_img_desc">
                                    <div class="col-md-4">Mayon Volcano</div>
